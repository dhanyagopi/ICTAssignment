...
public class OrderTotal extends Driver {
    ...
    public void Search(ArrayList<String> item) throws IOException {
        ...
        // TC_AJ_007
        Double total = (newBagTotal + newEstimatedGst + newDelivery) - newBagDiscount;
        Assert.assertEquals(String.format("%.2f", total), String.format("%.2f", newOrderTotal));
